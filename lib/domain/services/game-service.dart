...
class GameService {
  ...
  void startGame() async {
    _gameStarted = true;
    activePlayer = _gameRoom.playerList[0];
  ...
  void nextTurn() {
    turnTimer = 0;
    int lastActivePlayer = _gameRoom.playerList.indexOf(activePlayer!);
    activePlayer = _gameRoom.playerList[(lastActivePlayer + 1) % _gameRoom.playerList.length];
  }
