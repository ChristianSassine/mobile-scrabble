                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ToggleIconButton(
                                      isOn: _isProtected,
                                      off_icon: Icons.lock_open_outlined,
                                      on_icon: Icons.lock_outline,
                                      onChanged: _isPublic
                                          ? (value) {
                                              setState(() {
                                                _isProtected = value;
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      menu.DropdownMenu(
                                        ...
                                        items: {
                                          FlutterI18n.translate(context,
                                                  "room_create.difficulty.easy"):
                                              GameDifficulty.Easy.value,
                                          FlutterI18n.translate(context,
                                                  "room_create.difficulty.hard"):
                                              GameDifficulty.Hard.value,
                                          FlutterI18n.translate(context,
                                                  "room_create.difficulty.score_based"):
                                              GameDifficulty.ScoreBased.value,
                                        },
                                        onChanged: (value) {
                                          _selectedDifficulty =
                                              GameDifficulty.fromString(
                                                  value!)!;
                                        },
                                      ...
                                      menu.DropdownMenu(
                                        ...
                                        items: {
                                          for (var item in _dictionaryService
                                              .dictionaries)
